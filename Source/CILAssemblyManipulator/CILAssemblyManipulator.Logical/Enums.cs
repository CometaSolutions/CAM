...
namespace CILAssemblyManipulator.Logical
{
   ...
   //   /// <summary>
   //   /// This enumerable contains values for possible target platforms when emitting <see cref="CILModule"/>.
   //   /// </summary>
   ...
   //   }
   //   /// <summary>
   //   /// This enumeration contains values for what kind of code is contained within the module when emitting <see cref="CILModule"/>.
   //   /// </summary>
   //   /// <seealso cref="EmittingArguments"/>.
   //   /// <remarks>
   ...
   //      /// </para>
   //      /// <para>
   //      /// Please note that if this flag is specified when emitting a <see cref="CILModule"/>, the flag <see cref="Required32Bit"/> should be set as well.
   //      /// </para>
   //      /// </remarks>
   ...
   //   /// <summary>
   //   /// The kind of the module being loaded or emitted. TODO: make load methods have out parameter of type ModuleKind.
   //   /// </summary>
   //   /// <seealso cref="EmittingArguments"/>.
   ...
   //   /// <summary>
   //   /// This enumeration is a copy of <see cref="System.Runtime.InteropServices.VarEnum"/>.
   ...
   //   /// <summary>
   //   /// This enumeration is a copy of <see cref="System.Runtime.InteropServices.UnmanagedType"/>.
   //   /// It is present in order to avoid warnings when compiling for Windows Phone 8.1.
   //   /// </summary>
...
public static partial class E_CILLogical
{
   ...
   //   /// </list>
   //   /// </remarks>
   //   public static Boolean IsNativeInstric( this CILAssemblyManipulator.Logical.UnmanagedType ut )
   //   {
   //      switch ( ut )
   //      {
