...
namespace CILAssemblyManipulator.Logical
{
   ...
   public interface MethodIL
   {
      ...
      /// <summary>
      /// Gets the module that owns this <see cref="MethodIL"/>.
      /// </summary>
      /// <value>The module that owns this <see cref="MethodIL"/>.</value>
...
public static partial class E_CILLogical
{
   ...
   private static readonly IDictionary<CILTypeCode, OpCode> CHECKED_UNSIGNED_CONV_OPCODES;
   private static readonly IDictionary<CILTypeCode, OpCode> CHECKED_SIGNED_CONV_OPCODES;
   private static readonly IDictionary<CILTypeCode, OpCode> UNCHECKED_UNSIGNED_CONV_OPCODES;
   private static readonly IDictionary<CILTypeCode, OpCode> UNCHECKED_SIGNED_CONV_OPCODES;
   ...
   static E_CILLogical()
   {
      ...
      CHECKED_UNSIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCode>();
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.Conv_Ovf_I1_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.Conv_Ovf_I2_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.Conv_Ovf_I4_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.Conv_Ovf_I8_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.Conv_Ovf_U1_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.Conv_Ovf_U2_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.Conv_Ovf_U2_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.Conv_Ovf_U4_Un );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.Conv_Ovf_U8_Un );

      CHECKED_SIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCode>();
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.Conv_Ovf_I1 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.Conv_Ovf_I2 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.Conv_Ovf_I4 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.Conv_Ovf_I8 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.Conv_Ovf_U1 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.Conv_Ovf_U2 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.Conv_Ovf_U2 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.Conv_Ovf_U4 );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.Conv_Ovf_U8 );

      UNCHECKED_UNSIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCode>();
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.Conv_I1 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.Conv_I2 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.Conv_I4 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.Conv_U8 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.Conv_U1 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.Conv_U2 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.Conv_U2 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.Conv_U4 );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.Conv_U8 );

      UNCHECKED_SIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCode>();
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.Conv_I1 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.Conv_I2 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.Conv_I4 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.Conv_I8 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.Conv_U1 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.Conv_U2 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.Conv_U2 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.Conv_U4 );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.Conv_I8 );
   }
   ...
   {
      return il.Add( unsigned ? OpCodes.Cgt_Un : OpCodes.Cgt );
   }
   ...
   {
      return il.Add( unsigned ? OpCodes.Clt_Un : OpCodes.Clt );
   }
   ...
   public static MethodIL EmitLoadInt32( this MethodIL il, Int32 value )
   {
      switch ( value )
      {
         ...
         case 1:
            ...
            break;
         case 2:
            il.Add( OpCodes.Ldc_I4_2 );
            break;
         case 3:
            il.Add( OpCodes.Ldc_I4_3 );
            break;
         case 4:
            il.Add( OpCodes.Ldc_I4_4 );
            break;
         case 5:
            il.Add( OpCodes.Ldc_I4_5 );
            break;
         case 6:
            il.Add( OpCodes.Ldc_I4_6 );
            break;
         case 7:
            il.Add( OpCodes.Ldc_I4_7 );
            break;
         case 8:
            il.Add( OpCodes.Ldc_I4_8 );
            break;
         default:
   ...
   public static MethodIL EmitNumericConversion( this MethodIL il, CILTypeCode typeFrom, CILTypeCode typeTo, Boolean checkOverflow )
   {
      if ( !typeFrom.Equals( typeTo ) )
      {
         ...
         if ( CILTypeCode.Single == typeTo )
         {
            if ( fromIsUnsigned )
            {
               il.Add( OpCodes.Conv_R_Un );
            }
            il.Add( OpCodes.Conv_R4 );
         }
   ...
   {
      return il.Add( overflowAndUnsigned.HasValue ? ( overflowAndUnsigned.Value ? OpCodes.Sub_Ovf_Un : OpCodes.Sub_Ovf ) : OpCodes.Sub );
   }
   ...
   /// <exception cref="NullReferenceException">If <paramref name="il"/> is <c>null</c>.</exception>
   public static MethodIL Add( this MethodIL il, OpCode noOperandOpCode )
   {
