...
namespace CILAssemblyManipulator.Logical.Implementation
{
   internal class CILModuleImpl : CILCustomAttributeContainerImpl, CILModule
   {
      ...
      private readonly IDictionary<OpCode, LogicalOpCodeInfoWithNoOperand> operandlessCodes;
 ...
 ref IDictionary<String, AbstractLogicalManifestResource> manifestResources,
         ref IDictionary<OpCode, LogicalOpCodeInfoWithNoOperand> operandlessCodes,
         String aName,
...
;
         ...
         operandlessCodes = new Dictionary<OpCode, LogicalOpCodeInfoWithNoOperand>( ReferenceEqualityComparer<OpCode>.ReferenceBasedComparer );
      }
      ...
      public LogicalOpCodeInfoWithNoOperand GetOperandlessOpCode( OpCode code )
      {
