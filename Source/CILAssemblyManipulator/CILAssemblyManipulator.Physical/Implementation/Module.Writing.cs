...
namespace CILAssemblyManipulator.Physical.Implementation
{
   internal static class ModuleWriter
   {
         ...
         )
      {
         ...
         //         }
         //         var thExtraData = headers.TablesHeaderExtraData;
         //         if ( thExtraData.HasValue )
         //         {
      ...
      //      private static Object[] CreateMDHeaps(
      //         CILMetaData md,
      //         Byte[] thisAssemblyPublicKey,
      //         ResizableArray<Byte> byteArrayHelper,
      ...
      //            return new HeapInfo3( blobs.RegisterBLOB( pk.IsNullOrEmpty() ? thisAssemblyPublicKey : pk ), sysStrings.RegisterString( ad.AssemblyInformation.Name ), sysStrings.RegisterString( ad.AssemblyInformation.Culture ) );
      //         } );
      //         // 0x21 AssemblyRef
