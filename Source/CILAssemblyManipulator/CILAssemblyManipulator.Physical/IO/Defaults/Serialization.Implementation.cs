...
#pragma warning restore 618
      ...
      {
         yield return DefaultColumnSerializationInfoFactory.RawValueStorageColumn<RawMethodDefinition, MethodDefinition>( nameof( RawMethodDefinition.RVA ), ( r, v ) => r.RVA = v, ( args, rva ) => args.Row.IL = this.DeserializeIL( args.RowArgs, rva, args.Row ), ( md, mdStreamContainer ) => this.ProcessSectionPart( new SectionPart_MethodIL( md, mdStreamContainer.UserStrings ) ) );
