...
namespace CILAssemblyManipulator.Implementation.Physical
{
   ...
   internal static class CryptoUtils
   {
      ...
      internal static RSAParameters CreateRSAParametersFromCapiBLOB( Byte[] blob, Int32 offset, out Int32 pkLen, out Int32 algID )
      {
         pkLen = 0;
         algID = 0;
         ...
         try
         {
               ...
               )
            {
               ...
               {
                  throw new CryptographicException( "Invalid key type: " + keyType );
               }
            }
            else
            {
