...
{
   /// <summary>
   /// This is abstract class for all <see cref="OpCodeInfo"/>s with one possible <see cref="OpCode"/>.
   /// </summary>
   public abstract class OpCodeInfoWithOneOpCode : OpCodeInfo
   {
      internal readonly OpCode _opCode;

      internal OpCodeInfoWithOneOpCode( OpCode code )
      {
         this._opCode = code;
      }
   ...
   /// <summary>
   /// This is <see cref="OpCodeInfo"/> for all <see cref="OpCode"/>s which take no operand.
   /// </summary>
   public sealed class OpCodeInfoWithNoOperand : OpCodeInfoWithOneOpCode
   {
      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithNoOperand"/>.
      /// </summary>
   ...
   /// <summary>
   /// This is abstract class for all <see cref="OpCodeInfo"/>s with fixed-size operand.
   /// </summary>
   public abstract class OpCodeInfoWithFixedSizeOperand : OpCodeInfoWithOneOpCode
   {
      internal const Byte TOKEN_SIZE = 4;

      internal readonly Byte _argSize;

      internal OpCodeInfoWithFixedSizeOperand( OpCode opCode, Byte argSize )
         : base( opCode )
      {
   ...
   /// <summary>
   /// This is abstract class for all <see cref="OpCodeInfo"/>s which accept a token as operand.
   /// </summary>
   public abstract class OpCodeInfoWithTokenOperand : OpCodeInfoWithFixedSizeOperand
   {
      internal readonly Boolean _useGDefIfPossible;

      internal OpCodeInfoWithTokenOperand( OpCode opCode, Boolean useGDefIfPossible )
   ...
   /// </summary>
   public sealed class OpCodeInfoWithTypeToken : OpCodeInfoWithTokenOperand
   {
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFieldToken : OpCodeInfoWithTokenOperand
   {
      private readonly CILField _field;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithFieldToken"/> with specified values.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      ...
      public OpCodeInfoWithFieldToken( OpCode opCode, CILField field, Boolean useGDefIfPossible = false )
         : base( opCode, useGDefIfPossible )
      {
   ...
   /// If the <see cref="OpCode"/> to emit is <see cref="OpCodes.Call"/>, <see cref="OpCodes.Callvirt"/>, <see cref="OpCodes.Ldftn"/> or <see cref="OpCodes.Ldvirtftn"/>, it is advicable to use the static factory methods in <see cref="OpCodeInfoForNormalOrVirtual"/> class.
   /// </summary>
   public sealed class OpCodeInfoWithMethodToken : OpCodeInfoWithTokenOperand
   {
   ...
   /// </summary>
   public sealed class OpCodeInfoForNormalOrVirtual : OpCodeInfo
   {
      private readonly CILMethod _method;
   ...
   /// </summary>
   public sealed class OpCodeInfoWithCtorToken : OpCodeInfoWithTokenOperand
   {
      private readonly CILConstructor _ctor;

      /// <summary>
      /// Creats a new instance of <see cref="OpCodeInfoWithCtorToken"/> with specified values.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      ...
      public OpCodeInfoWithCtorToken( OpCode opCode, CILConstructor ctor, Boolean useGDefIfPossible = false )
         : base( opCode, useGDefIfPossible )
      {
   ...
   /// </summary>
   public sealed class OpCodeInfoWithMethodSig : OpCodeInfoWithTokenOperand
   {
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFixedSizeOperandString : OpCodeInfoWithFixedSizeOperand
   {
      private readonly String _string;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithFixedSizeOperandString"/>
      /// </summary>
      /// <param name="str"></param>
      public OpCodeInfoWithFixedSizeOperandString( String str )
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFixedSizeOperandUInt16 : OpCodeInfoWithFixedSizeOperand
   {
      private readonly Int16 _int16;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithFixedSizeOperandUInt16"/> with specified <see cref="OpCode"/> and operand.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      ...
      /// </remarks>
      public OpCodeInfoWithFixedSizeOperandUInt16( OpCode opCode, Int16 int16 )
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFixedSizeOperandInt32 : OpCodeInfoWithFixedSizeOperand
   {

      private readonly Int32 _int32;

      /// <summary>
      /// Creates a new instane of <see cref="OpCodeInfoWithFixedSizeOperandInt32"/> with specified <see cref="OpCode"/> and operand.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      ...
      /// </remarks>
      public OpCodeInfoWithFixedSizeOperandInt32( OpCode opCode, Int32 int32 )
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFixedSizeOperandInt64 : OpCodeInfoWithFixedSizeOperand
   {
      private readonly Int64 _int64;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithFixedSizeOperandInt64"/> with specified <see cref="OpCode"/> and operand.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      /// <param name="int64">The operand.</param>
      public OpCodeInfoWithFixedSizeOperandInt64( OpCode opCode, Int64 int64 )
         : base( opCode, (Byte) 8 )
      {
         this._int64 = int64;
      }
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFixedSizeOperandSingle : OpCodeInfoWithFixedSizeOperand
   {
      private readonly Single _single;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithFixedSizeOperandSingle"/> with specified <see cref="OpCode"/> and operand.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      /// <param name="single">The operand.</param>
      public OpCodeInfoWithFixedSizeOperandSingle( OpCode opCode, Single single )
         : base( opCode, (Byte) 4 )
      {
         this._single = single;
      }
   ...
   /// </summary>
   public sealed class OpCodeInfoWithFixedSizeOperandDouble : OpCodeInfoWithFixedSizeOperand
   {
      private readonly Double _double;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithFixedSizeOperandDouble"/> with specified <see cref="OpCode"/> and operand.
      /// </summary>
      /// <param name="opCode">The <see cref="OpCode"/> to emit.</param>
      /// <param name="dbl">The operand.</param>
      public OpCodeInfoWithFixedSizeOperandDouble( OpCode opCode, Double dbl )
         : base( opCode, (Byte) 8 )
      {
         this._double = dbl;
      }
   ...
   /// <summary>
   /// This is base class for <see cref="OpCodeInfo"/>s having per-instance size information.
   /// </summary>
   public abstract class DynamicOpCodeInfo : OpCodeInfo
   {
      private readonly Int32 _minSize;
      private readonly Int32 _maxSize;
      ...
      internal DynamicOpCodeInfo( Int32 fixedSize )
         : this( fixedSize, fixedSize )
      {

      }

      internal DynamicOpCodeInfo( Int32 minSize, Int32 maxSize )
      {
         if ( minSize < 1 )
         {
   ...
   /// <summary>
   /// This is abstract class for <see cref="OpCodeInfo"/>s emitting branch or leave instruction.
   /// </summary>
   public abstract class OpCodeInfoForBranchingControlFlow : DynamicOpCodeInfo
   {


      internal readonly ILLabel _targetLabel;

      internal OpCodeInfoForBranchingControlFlow( Int32 min, Int32 max, ILLabel targetLabel )
         : base( min, max )
      {
      ...
      /// <summary>
      /// Gets the target <see cref="ILLabel"/> for this <see cref="OpCodeInfoForBranchingControlFlow"/>.
      /// </summary>
   ...
   /// </summary>
   public sealed class OpCodeInfoForBranch : OpCodeInfoForBranchingControlFlow
   {
      ...
      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoForBranch"/>, which will try its best to emit short-form version of the branch instruction.
      /// </summary>
      /// <param name="bType">The <see cref="BranchType"/>.</param>
      /// <param name="targetLabel">The <see cref="ILLabel"/> where to branch.</param>
      public OpCodeInfoForBranch( BranchType bType, ILLabel targetLabel )
      ...
      internal OpCodeInfoForBranch( OpCode code, Boolean isShort, ILLabel targetLabel )
   ...
   /// </summary>
   public sealed class OpCodeInfoForSwitch : DynamicOpCodeInfo
   {
      private readonly ILLabel[] _labels;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoForSwitch"/> with specified labels to use as branching table.
      /// </summary>
      /// <param name="labels">The <see cref="ILLabel"/> to use as branching table.</param>
      public OpCodeInfoForSwitch( ILLabel[] labels )
   ...
   /// </summary>
   public sealed class OpCodeInfoForLeave : OpCodeInfoForBranchingControlFlow
   {

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoForLeave"/> with specified label.
      /// </summary>
      /// <param name="label">The label marking end of handler block.</param>
      public OpCodeInfoForLeave( ILLabel label )
   ...
   /// </summary>
   public sealed class OpCodeInfoForFixedBranchOrLeave : DynamicOpCodeInfo
   {
      private readonly OpCode _code;
      private readonly ILLabel _label;

      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoForFixedBranchOrLeave"/> with specified <see cref="OpCode"/> and <see cref="ILLabel"/>.
      /// </summary>
      /// <param name="code">The <see cref="OpCode"/>.</param>
      /// <param name="label">The <see cref="ILLabel"/> to branch to.</param>
      public OpCodeInfoForFixedBranchOrLeave( OpCode code, ILLabel label )
      ...
      /// <summary>
      /// Gets the fixed branch code for this <see cref="OpCodeInfoForFixedBranchOrLeave"/>.
      /// </summary>
      /// <value>The fixed branch code for this <see cref="OpCodeInfoForFixedBranchOrLeave"/>.</value>
      public OpCode Code
      {
         get
         {
