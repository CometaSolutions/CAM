...
namespace CILAssemblyManipulator.API
{
   ...
   public interface CILElementWithCustomModifiers : CILElementWithCustomModifiersReadOnly
   {
      ...
      /// <param name="optionality">Whether custom modifiers is optional or required.</param>
      ...
      CILCustomModifier AddCustomModifier( CILType type, CILCustomModifierOptionality optionality );
   ...
   public interface CILElementWithMarshalingInfo
   {
      ...
      MarshalingInfo MarshalingInformation { get; set; }
   }
   ...
   public sealed class MarshalingInfo
   {
      ...
      public MarshalingInfo( UnmanagedType ut, VarEnum safeArrayType, CILType safeArrayUDType, Int32 iidParamIdx, UnmanagedType arrayType, Int32 sizeParamIdx, Int32 constSize, String marshalTN, Func<String, CILType> marshalType, String marshalCookie )
      {
         this._ut = ut;
      ...
      public static MarshalingInfo MarshalAs( UnmanagedType ut )
      {
         ...
         {
            return new MarshalingInfo( ut, VarEnum.VT_EMPTY, null, NO_INDEX, NATIVE_TYPE_MAX, NO_INDEX, NO_INDEX, null, null, null );
         }
         else
         {
      ...
      public static MarshalingInfo MarshalAsByValTStr( Int32 size )
      {
         ...
         return new MarshalingInfo( UnmanagedType.ByValTStr, VarEnum.VT_EMPTY, null, NO_INDEX, NATIVE_TYPE_MAX, NO_INDEX, size, null, null, null );
      }
      ...
      {
         return new MarshalingInfo( unknown ? UnmanagedType.IUnknown : UnmanagedType.IDispatch, VarEnum.VT_EMPTY, null, iidParamIndex, NATIVE_TYPE_MAX, NO_INDEX, NO_INDEX, null, null, null );
      }
      ...
      /// <returns>A new <see cref="MarshalingInfo"/> with given information.</returns>
      public static MarshalingInfo MarshalAsSafeArray( CILType elementType )
      {
         return MarshalAsSafeArray( elementType == null ? VarEnum.VT_EMPTY : VarEnum.VT_USERDEFINED, elementType );
      }

      private static MarshalingInfo MarshalAsSafeArray( VarEnum elementType, CILType udType )
      {
         return new MarshalingInfo( UnmanagedType.SafeArray, elementType, udType, NO_INDEX, NATIVE_TYPE_MAX, NO_INDEX, NO_INDEX, null, null, null );
      }
      ...
      public static MarshalingInfo MarshalAsByValArray( Int32 size, UnmanagedType elementType = NATIVE_TYPE_MAX )
      {
         ...
         return new MarshalingInfo( UnmanagedType.ByValArray, VarEnum.VT_EMPTY, null, NO_INDEX, elementType, NO_INDEX, size, null, null, null );
      }
      ...
      {
         return new MarshalingInfo( UnmanagedType.LPArray, VarEnum.VT_EMPTY, null, NO_INDEX, elementType, sizeParamIdx, constSize, null, null, null );
      }
      ...
      public static MarshalingInfo MarshalAsCustom( CILType customMarshaler, String marshalCookie = null )
      {
      ...
      internal static MarshalingInfo MarshalAsCustom( String customMarshalerTypeName, Func<String, CILType> customMarshaler, String marshalCookie )
      {
         return new MarshalingInfo( UnmanagedType.CustomMarshaler, VarEnum.VT_EMPTY, null, NO_INDEX, NATIVE_TYPE_MAX, NO_INDEX, NO_INDEX, customMarshalerTypeName, customMarshaler, marshalCookie );
      }
      ...
      public static MarshalingInfo FromAttribute( System.Runtime.InteropServices.MarshalAsAttribute attr, CILReflectionContext ctx )
      {
         ...
         else
         {
            ...
            result = new MarshalingInfo( (UnmanagedType) attr.Value, (VarEnum) attr.SafeArraySubType, attr.SafeArrayUserDefinedSubType.NewWrapperAsType( ctx ), attr.IidParameterIndex, (UnmanagedType) attr.ArraySubType, attr.SizeParamIndex, attr.SizeConst, attr.MarshalType, tn =>
            {
   ...
   public class SecurityInformation
   {
      ...
      internal SecurityInformation( SecurityAction action, CILType securityAttributeType, IEnumerable<CILCustomAttributeNamedArgument> namedArgs = null )
      {
         this._action = action;
   ...
   public interface CILElementWithSecurityInformation
   {
      ...
      SecurityInformation AddDeclarativeSecurity( SecurityAction action, CILType securityAttributeType );
      ...
      Boolean RemoveDeclarativeSecurity( SecurityInformation information );
   }
}
...
public static partial class E_CIL
{
   ...
   {
      return element.AddCustomModifier( type, CILCustomModifierOptionality.Optional );
   }
   ...
   {
      return element.AddCustomModifier( type, CILCustomModifierOptionality.Required );
   }

#if WINDOWS_PHONE_APP

   // In some places, adding "using System.Reflection;" would cause massive havoc and need to prepend everything with CILAssemblyManipulator.API namespace.
