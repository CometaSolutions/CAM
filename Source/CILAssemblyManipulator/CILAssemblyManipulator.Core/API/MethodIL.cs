...
namespace CILAssemblyManipulator.API
{
   ...
   {
      /// <summary>
      /// Adds a new <see cref="OpCodeInfo"/> at the end of this method body.
      /// </summary>
      /// <param name="opCodeInfo">The <see cref="OpCodeInfo"/>.</param>
      ...
      MethodIL Add( OpCodeInfo opCodeInfo );

      /// <summary>
      /// Gets the amount of <see cref="OpCodeInfo"/>s in this method body.
      /// </summary>
      /// <value>The amount of <see cref="OpCodeInfo"/>s in this method body.</value>
      ...
      /// <summary>
      /// Gets all the <see cref="OpCodeInfo"/>s currently contained within this <see cref="MethodIL"/>.
      /// </summary>
      /// <value>All the <see cref="OpCodeInfo"/>s currently contained within this <see cref="MethodIL"/>.</value>
      IEnumerable<OpCodeInfo> OpCodeInfos { get; }
   ...
   public abstract class OpCodeInfo
   {
      ...
      /// <summary>
      /// Gets the minimum amount of bytes that may be emitted for this <see cref="OpCodeInfo"/>.
      /// </summary>
      /// <value>The minimum amount of bytes that may be emitted for this <see cref="OpCodeInfo"/>.</value>
      internal abstract Int32 MinSize { get; }

      /// <summary>
      /// Gets the maximum amount of bytes that may be emitted for this <see cref="OpCodeInfo"/>.
      /// </summary>
      /// <value>The maximum amount of bytes that may be emitted for this <see cref="OpCodeInfo"/>.</value>
      internal abstract Int32 MaxSize { get; }

      /// <summary>
      /// Gets the amount of branch instructions for this <see cref="OpCodeInfo"/>. Should be <c>0</c> for non-branching instructions, <c>1</c> for normal branches, and <c>X</c> for switch instruction, where <c>X</c> is amount of cases.
      /// </summary>
      /// <value>The amount of branch instructions for this <see cref="OpCodeInfo"/>.</value>
      internal abstract Int32 BranchTargetCount { get; }

      /// <summary>
      /// Gets the <see cref="OpCodeInfoKind"/> identifying what kind of <see cref="OpCodeInfo"/> this is.
      /// </summary>
      /// <value>The <see cref="OpCodeInfoKind"/> identifying what kind of <see cref="OpCodeInfo"/> this is.</value>
      public abstract OpCodeInfoKind InfoKind { get; }
   }

   /// <summary>
   /// This enumeration easily identifies what kind is any <see cref="OpCodeInfo"/>.
   /// </summary>
   /// <seealso cref="OpCodeInfo.InfoKind"/>
   public enum OpCodeInfoKind
   {
      /// <summary>
      /// This is <see cref="OpCodeInfoWithNoOperand"/>.
      /// </summary>
      OperandNone,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithTypeToken"/>.
      /// </summary>
      OperandTypeToken,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFieldToken"/>.
      /// </summary>
      OperandFieldToken,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithMethodToken"/>.
      /// </summary>
      OperandMethodToken,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithCtorToken"/>.
      /// </summary>
      OperandCtorToken,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithMethodSig"/>.
      /// </summary>
      OperandMethodSigToken,
      /// <summary>
      /// This is <see cref="OpCodeInfoForNormalOrVirtual"/>.
      /// </summary>
      NormalOrVirtual,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFixedSizeOperandString"/>.
      /// </summary>
      OperandString,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFixedSizeOperandUInt16"/>.
      /// </summary>
      OperandUInt16,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFixedSizeOperandInt32"/>.
      /// </summary>
      OperandInt32,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFixedSizeOperandInt64"/>.
      /// </summary>
      OperandInt64,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFixedSizeOperandSingle"/>.
      /// </summary>
      OperandR4,
      /// <summary>
      /// This is <see cref="OpCodeInfoWithFixedSizeOperandDouble"/>.
      /// </summary>
      OperandR8,
      /// <summary>
      /// This is <see cref="OpCodeInfoForBranch"/>.
      /// </summary>
      Branch,
      /// <summary>
      /// This is <see cref="OpCodeInfoForSwitch"/>.
      /// </summary>
      Switch,
      /// <summary>
      /// This is <see cref="OpCodeInfoForLeave"/>.
      /// </summary>
      Leave,
      /// <summary>
      /// This is <see cref="OpCodeInfoForFixedBranchOrLeave"/>.
      /// </summary>
      BranchOrLeaveFixed
   }
   ...
   /// The unit of all offsets and lengths in this class is <see cref="OpCodeInfo"/>.
   ...
   public sealed class ExceptionBlockInfo
   {
      ...
      /// <param name="tryOffset">The <see cref="OpCodeInfo"/>-based offset of the try-block.</param>
      /// <param name="tryLength">The <see cref="OpCodeInfo"/>-based length of the try-block.</param>
      /// <param name="handlerOffset">The <see cref="OpCodeInfo"/>-based offset of the handler block.</param>
      /// <param name="handlerLength">The <see cref="OpCodeInfo"/>-based length of the handler block.</param>
      /// <param name="exceptionType">The exception handling type or <c>null</c>.</param>
      /// <param name="filterOffset">The <see cref="OpCodeInfo"/>-based offset of the filter block.</param>
      ...
      /// <summary>
      /// Gets the <see cref="OpCodeInfo"/>-based offset of the try-block.
      /// </summary>
      /// <value>The <see cref="OpCodeInfo"/>-based offset of the try-block.</value>
      ...
      /// <summary>
      /// Gets the <see cref="OpCodeInfo"/>-based length of the try-block.
      /// </summary>
      /// <value>The <see cref="OpCodeInfo"/>-based length of the try-block.</value>
      ...
      /// <summary>
      /// Gets the <see cref="OpCodeInfo"/>-based offset of the handler block.
      /// </summary>
      /// <value>The <see cref="OpCodeInfo"/>-based offset of the handler block.</value>
      ...
      /// <summary>
      /// Gets the <see cref="OpCodeInfo"/>-based length of the handler block.
      /// </summary>
      /// <value>The <see cref="OpCodeInfo"/>-based length of the handler block.</value>
      ...
      /// <summary>
      /// Gets the <see cref="OpCodeInfo"/>-based offset of the filter block.
      /// </summary>
      /// <value>The <see cref="OpCodeInfo"/>-based offset of the filter block.</value>
...
public static class E_MethodIL
{
   ...
   private static readonly IDictionary<CILTypeCode, OpCodeInfo> CHECKED_UNSIGNED_CONV_OPCODES;
   private static readonly IDictionary<CILTypeCode, OpCodeInfo> CHECKED_SIGNED_CONV_OPCODES;
   private static readonly IDictionary<CILTypeCode, OpCodeInfo> UNCHECKED_UNSIGNED_CONV_OPCODES;
   private static readonly IDictionary<CILTypeCode, OpCodeInfo> UNCHECKED_SIGNED_CONV_OPCODES;
   ...
   static E_MethodIL()
   {
      ...
      CHECKED_UNSIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCodeInfo>();
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I1_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I2_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I4_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I8_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U1_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U2_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U2_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U4_Un] );
      CHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U8_Un] );

      CHECKED_SIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCodeInfo>();
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I1] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I2] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I4] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_I8] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U1] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U2] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U2] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U4] );
      CHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_Ovf_U8] );

      UNCHECKED_UNSIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCodeInfo>();
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I1] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I2] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I4] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U8] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U1] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U2] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U2] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U4] );
      UNCHECKED_UNSIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U8] );

      UNCHECKED_SIGNED_CONV_OPCODES = new Dictionary<CILTypeCode, OpCodeInfo>();
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.SByte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I1] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I2] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I4] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Int64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I8] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Byte, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U1] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt16, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U2] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.Char, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U2] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt32, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_U4] );
      UNCHECKED_SIGNED_CONV_OPCODES.Add( CILTypeCode.UInt64, OpCodes.CodeInfosWithNoOperand[OpCodeEncoding.Conv_I8] );
   }
   ...
   {
      return il.Add( new OpCodeInfoForBranch( branchType, targetLabel ) );
   }
   ...
   {
      return il.Add( OpCodeInfoForNormalOrVirtual.OpCodeInfoForCall( method ) );
   }
   ...
   {
      return il.Add( new OpCodeInfoWithCtorToken(
         OpCodes.Call,
         ctor
         ) );
   }
   ...
   public static MethodIL EmitCall( this MethodIL il, CILMethodSignature methodSig, params Tuple<CILCustomModifier[], CILTypeBase>[] varArgs )
   {
      ...
      return il.Add( new OpCodeInfoWithMethodSig( methodSig, varArgs ) );
   }
   ...
   {
      return il.Add( new OpCodeInfoWithMethodToken(
         OpCodes.Call,
         method
         ) );
   }
   ...
   public static MethodIL EmitCastToType( this MethodIL il, CILTypeBase typeFrom, CILTypeBase typeTo )
   {
      ...
      if ( !typeFrom.Equals( typeTo ) )
      {
         ...
         {
            il.Add( new OpCodeInfoWithTypeToken(
               OpCodes.Unbox_Any,
               typeTo
               ) );
         }
   ...
   {
      return il.Add( new OpCodeInfoWithTypeToken( OpCodes.Constrained_, type ) )
         .Add( new OpCodeInfoWithMethodToken( OpCodes.Callvirt, method ) );
   }
   ...
   {
      return il.Add( new OpCodeInfoWithTypeToken(
         OpCodes.Initobj,
         valueType
         ) );
   }
   ...
   {
      return il.Add( new OpCodeInfoForLeave( label ) );
   }
   ...
   {
      return il.Add( new OpCodeInfoWithFixedSizeOperandUInt16(
   ...
   {
      return il.Add( new OpCodeInfoWithFixedSizeOperandInt64(
         OpCodes.Ldc_I8,
         value
         ) )
         //
   ...
   {
      return il.Add( new OpCodeInfoWithFixedSizeOperandSingle(
         OpCodes.Ldc_R4,
         value
         ) );
   }
   ...
   {
      return il.Add( new OpCodeInfoWithFixedSizeOperandDouble(
         OpCodes.Ldc_R8,
         value
         ) );
   }
   ...
   {
      return il.Add(
         new OpCodeInfoWithTypeToken( OpCodes.Ldelema, type )
         );
   }
   ...
   public static MethodIL EmitLoadThisField( this MethodIL il, CILField field, Boolean isVolatile = false )
   {
      ...
      return il.Add( new OpCodeInfoWithFieldToken(
         code,
         field
         ) );
   }
   ...
   public static MethodIL EmitLoadInt32( this MethodIL il, Int32 value )
   {
      switch ( value )
      {
         ...
         case 8:
            ...
            break;
         default:
            il.Add( new OpCodeInfoWithFixedSizeOperandInt32(
   ...
   public static MethodIL EmitLoadLocalAddress( this MethodIL il, LocalBuilder local )
   {
      ...
      il.Add( new OpCodeInfoWithFixedSizeOperandUInt16(
   ...
   {
      return il.Add( new OpCodeInfoWithFixedSizeOperandString( str ) );
   }
   ...
   {
      return il.Add( OpCodeInfoForNormalOrVirtual.OpCodeInfoForLdFtn( method ) );
   }
   ...
   public static MethodIL EmitSizeOf( this MethodIL il, CILTypeBase type )
   {
      ...
      return il.Add( new OpCodeInfoWithTypeToken( OpCodes.Sizeof, type ) );
   }
   ...
   public static MethodIL EmitSwitch( this MethodIL il, Int32 amountOfCases, Action<MethodIL, ILLabel[], ILLabel?, ILLabel> cases, Action<MethodIL, ILLabel> defaultCase )
   {
      ...
      il.Add( new OpCodeInfoForSwitch( labels ) );
   ...
   private static MethodIL EmitStoreField( MethodIL il, CILField field, Boolean isThisField, Action<MethodIL> whatToStore, Boolean isVolatile )
   {
      ...
      il.Add( new OpCodeInfoWithFieldToken(
         code,
         field
         ) );
      return il;
   ...
   {
      return il.Add( OpCodes.CodeInfosWithNoOperand[noOperandOpCode] );
   }
