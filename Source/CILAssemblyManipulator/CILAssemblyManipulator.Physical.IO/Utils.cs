...
{
   // This class will be internal-ized in merge.
#pragma warning disable 1591
   public static class BitUtils
   {
      ...
      public static Byte[] CompressUInt32( this Byte[] array, ref Int32 offset, Int32 value )
      {
         return EncodeUInt32( array, ref offset, value, EncodingForcePolicy.DontForce );
      }

      public static Byte[] CompressInt32( this Byte[] array, ref Int32 offset, Int32 value )
      {
         Int32 uValue = value;
         ...
         return EncodeUInt32( array, ref offset, uValue, policy );
      }

      private static Byte[] EncodeUInt32( Byte[] array, ref Int32 offset, Int32 value, EncodingForcePolicy forcePolicy )
      {
      ...
      public static Int32 GetEncodedIntSize( Int32 value )
      {
         if ( value >= INT_ONE_BYTE_MIN && value <= INT_ONE_BYTE_MAX )
         {
            return 1;
      ...
      public static Int32 GetEncodedUIntSize( Int32 value )
      {
         if ( value < 0 )
         {
      ...
      public static Int32 DecompressUInt32( this Byte[] stream, ref Int32 idx )
      {
      ...
      public static Boolean TryDecompressUInt32( this Byte[] stream, ref Int32 idx, Int32 max, out Int32 value, Boolean acceptErraneous = true )
      {
         const Int32 UINT_TWO_BYTES_DECODE_MASK = 0x3F;
         const Int32 UINT_FOUR_BYTES_DECODE_MASK = 0x1F;
      ...
      public static Int32 DecodeTypeDefOrRefOrSpec( this Byte[] array, ref Int32 idx )
      {
      ...
      public static Int32 EncodeTypeDefOrRefOrSpec( this Int32 token )
      {
         Int32 encodedValue;
