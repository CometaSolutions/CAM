...
namespace CILAssemblyManipulator.Physical.TypeRemapping
{
      ...
      where TAssemblyReferenceDicInner : class, IDictionary<AssemblyInformationForResolving, CILMetaData>
   {
         ...
         )
      {
         ...
         this._targetFWAssemblies = ArgumentValidator.ValidateNotNull( "Target framework assemblies dictionary", targetFWAssemblies );
         this._resolvedTargetFWAssemblies = ArgumentValidator.ValidateNotNull( "Resolved target framework assemblies dictionary", resolvedTargetFWAssemblies );
      ...
      >
   {
      ...
      /// <summary>
      /// Implements <see cref="AbstractTargetFrameworkMapper{TTypesDic, TTargetFWAssembliesDic, TResolvedTargetFWAssembliesDic, TResolvedTargetFWAssembliesDicInner, TAssemblyReferenceDic, TAssemblyReferenceDicInner}.GetOrAdd_TargetFWAssemblies"/> by calling <see cref="M:E_UtilPack.GetOrAdd_NotThreadSafe{TKey, TValue}(IDictionary{TKey, TValue}, TKey, Func{TKey, TValue})"/>.
      /// </summary>
      /// <param name="dic">The dictionary.</param>
      /// <param name="key">The key to dictionary.</param>
      /// <param name="factory">The factory callback, if the value is not present for given <paramref name="key"/>.</param>
      ...
      /// <summary>
      /// Implements <see cref="AbstractTargetFrameworkMapper{TTypesDic, TTargetFWAssembliesDic, TResolvedTargetFWAssembliesDic, TResolvedTargetFWAssembliesDicInner, TAssemblyReferenceDic, TAssemblyReferenceDicInner}.GetOrAdd_MDTypes"/> by calling <see cref="M:E_UtilPack.GetOrAdd_NotThreadSafe{TKey, TValue}(IDictionary{TKey, TValue}, TKey, Func{TKey, TValue})"/>.
      /// </summary>
      /// <param name="dic">The dictionary.</param>
      /// <param name="key">The key to dictionary.</param>
      /// <param name="factory">The factory callback, if the value is not present for given <paramref name="key"/>.</param>
      ...
      /// <summary>
      /// Implements <see cref="AbstractTargetFrameworkMapper{TTypesDic, TTargetFWAssembliesDic, TResolvedTargetFWAssembliesDic, TResolvedTargetFWAssembliesDicInner, TAssemblyReferenceDic, TAssemblyReferenceDicInner}.GetOrAdd_ResolvedTargetFWAssemblies"/> by calling <see cref="M:E_UtilPack.GetOrAdd_NotThreadSafe{TKey, TValue}(IDictionary{TKey, TValue}, TKey, Func{TKey, TValue})"/>.
      /// </summary>
      /// <param name="dic">The dictionary.</param>
      /// <param name="key">The key to dictionary.</param>
      /// <param name="factory">The factory callback, if the value is not present for given <paramref name="key"/>.</param>
      ...
      /// <summary>
      /// Implements <see cref="AbstractTargetFrameworkMapper{TTypesDic, TTargetFWAssembliesDic, TResolvedTargetFWAssembliesDic, TResolvedTargetFWAssembliesDicInner, TAssemblyReferenceDic, TAssemblyReferenceDicInner}.GetOrAdd_AssemblyReferences"/> by calling <see cref="M:E_UtilPack.GetOrAdd_NotThreadSafe{TKey, TValue}(IDictionary{TKey, TValue}, TKey, Func{TKey, TValue})"/>.
      /// </summary>
      /// <param name="dic">The dictionary.</param>
      /// <param name="key">The key to dictionary.</param>
      /// <param name="factory">The factory callback, if the value is not present for given <paramref name="key"/>.</param>
      ...
      /// <summary>
      /// Implements <see cref="AbstractTargetFrameworkMapper{TTypesDic, TTargetFWAssembliesDic, TResolvedTargetFWAssembliesDic, TResolvedTargetFWAssembliesDicInner, TAssemblyReferenceDic, TAssemblyReferenceDicInner}.GetOrAdd_AssemblyReferencesInner"/> by calling <see cref="M:E_UtilPack.GetOrAdd_NotThreadSafe{TKey, TValue}(IDictionary{TKey, TValue}, TKey, Func{TKey, TValue})"/>.
      /// </summary>
      /// <param name="dic">The dictionary.</param>
      /// <param name="key">The key to dictionary.</param>
      /// <param name="factory">The factory callback, if the value is not present for given <paramref name="key"/>.</param>
