...
namespace CILAssemblyManipulator.Physical
{
   ...
   public interface IOpCodeInfo
   {
      ...
      /// <summary>
      /// Gets the <see cref="Physical.OpCode"/> for this <see cref="IOpCodeInfo"/>.
      /// </summary>
   ...
   /// </summary>
   /// <remarks>
   /// The instances of this class are not instantiable directly, instead use <see cref="OpCodeInfoWithNoOperand"/>, <see cref="OpCodeInfoWithOperandGetter{TOperand}"/>, or <see cref="OpCodeInfoWithOperand{TOperand}"/>.
   /// </remarks>
   public abstract class OpCodeInfo : IOpCodeInfo
   {
      ...
      /// <summary>
      /// Gets the <see cref="Physical.OpCode"/> for this <see cref="OpCodeInfo"/>.
      /// </summary>
      /// <seealso cref="Physical.OpCodeID"/>
      /// <seealso cref="Physical.OpCode"/>
      /// <seealso cref="OpCodes"/>
      public OpCode OpCodeID
      {
         get
         {
            return this._code;
   ...
   /// One reason for this is that <see cref="OpCodeInfoWithOperand{TOperand}"/> provides both getter and setter for operand, which is not always sensible (e.g. for <see cref="OpCodes.Switch"/>).
   /// </remarks>
   ...
   /// <remarks>
   /// </remarks>
   public class OpCodeInfoWithOperand<TOperand> : OpCodeInfo, IOpCodeInfoWithOperandAndSetter<TOperand>
   {
      ...
      public OpCodeInfoWithOperand( OpCode code, TOperand operand )
         : base( code )
      {
   ...
   /// <summary>
   /// This is base class for all <see cref="OpCodeInfo"/>s which have a gettable, but not settable, operand of some sort.
   /// </summary>
   /// <typeparam name="TOperand">The type of the operand.</typeparam>
   /// <remarks>
   /// </remarks>
   public class OpCodeInfoWithOperandGetter<TOperand> : OpCodeInfo, IOpCodeInfoWithOperand<TOperand>
   {
      /// <summary>
      ...
      /// <param name="code">The <see cref="OpCode"/>.</param>
      /// <param name="operand">The operand.</param>
      public OpCodeInfoWithOperandGetter( OpCode code, TOperand operand )
         : base( code )
      {
         this.Operand = operand;
      }
   ...
   /// <summary>
   /// This class represents op code info with a list of elements as operand.
   /// </summary>
   /// <typeparam name="TListElement">The type of list elements.</typeparam>
   public class OpCodeInfoWithList<TListElement> : OpCodeInfoWithOperandGetter<List<TListElement>>
   {
      /// <summary>
      /// Creates a new instance of <see cref="OpCodeInfoWithList{TListElement}"/> with given <see cref="OpCodeID"/> and initial list capacity.
      /// </summary>
      /// <param name="code">The <see cref="OpCode"/>.</param>
      /// <param name="listCapacity">The initial list capacity.</param>
      public OpCodeInfoWithList( OpCode code, Int32 listCapacity )
         : base( code, new List<TListElement>( listCapacity ) )
      {
