...
namespace CILAssemblyManipulator.Physical.Meta
{
   ...
   public class DefaultSignatureProvider : SignatureProvider
   {
      ...
      public DefaultSignatureProvider( IEnumerable<SimpleTypeSignature> simpleTypeSignatures = null )
      {
...
{
   public static SimpleTypeSignature GetSimpleTypeSignature( this SignatureProvider opCodeProvider, SimpleTypeSignatureKind kind )
   {
      var retVal = opCodeProvider.GetSimpleTypeSignatureOrNull( kind );
      if ( retVal == null )
      {
